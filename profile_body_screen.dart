              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120044', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Mohamad Almubarok', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Barok', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Lingkungan 03 Citatah dalam Rt 04 / Rw 08, Kel.Ciriung, Kec.Cibinong, Kab.Bogor',
